namespace VirtualInputHardware.UWP
{
    using System;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    Symbol = Symbol.Link,
                    Label = "Connect",
                    DestPage = typeof(ConnectionPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.TouchPointer,
                    Label = "Mouse",
                    DestPage = typeof(MousePage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.View,
                ...
                new NavMenuItem()
                {
                    ...
                    Label = " Demo Basic Page",
                    DestPage = typeof(BasicPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Edit,
                    Label = "Demo CommandBar Page",
                    DestPage = typeof(CommandBarPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Favorite,
                    Label = "Demo Drill In Page",
